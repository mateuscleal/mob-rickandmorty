...
class AppColors {
  static const Color primary = Color(0xFF21D190); // Verde neon
  static const Color secondary = Color(0xFF00A0CC); // Azul turquesa
  static const Color accent = Color(0xFFC8D357); // Amarelo Lima
  static const Color background = Color(0xFF000000); // P reto para fundo
